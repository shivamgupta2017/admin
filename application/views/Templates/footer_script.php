<!-- jQuery 2.1.4 -->
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.2.8/angular.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/js/dataTables.bootstrap.min.js"></script>
      ...
      <!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCc-lzpfikvgMLjBzGqXSttomHhcZOQ2UA"
...
function doconfirm1()
{
    job=confirm("Are you sure to Perform this action?");
     if(job!=true)
    {
        return false;
    }
