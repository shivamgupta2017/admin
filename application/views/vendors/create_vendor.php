                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Business Title</label>
                            ...
                            data-parsley-minlength="2"  required="" name="vendor_name"  placeholder="Business Title">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Mobile</label>
                            <input type="tel" class="form-control required" data-parsley-trigger="change"  
                            data-parsley-minlength="10" data-parsley-maxlength="10" required="" name="mobile" placeholder="Mobile No">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">GSTIN No</label>
                            <input type="text" class="form-control required" data-parsley-trigger="change"  data-parsley-pattern="^[0-9\  \/]+$"
                            data-parsley-minlength="6" data-parsley-maxlength="15"   required="" id="gstin" name="gstin"  placeholder="GSTIN No">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
