<div class="content-wrapper">
	...
	<div class="col-md-6">
                  ...
                  <div class="user-profile-pic">
				   ...
				   <div class="form-group has-feedback">
                     <li class="list-group-item">
                      <b>Username</b> <a class="pull-right name-color"><?php echo $data->username; ?></a>
                    </li>
				   </div>
                </div><!-- /.box-body -->
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Profile_ctrl/admin_change_password" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
